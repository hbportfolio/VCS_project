<footer class="section8">
    <div class="container">
        <div class="main-section">
            <div class="left-col">
                <h5>Italian Food</h5>
                <p>Discover authentic Italian dishes with our collection of classic recipes, expertly crafted and curated by our Italian culinary team. Indulge in taste and tradition.</p>
            </div>
            <div class="right-col">
                <div>
                    <h5>About</h5>
